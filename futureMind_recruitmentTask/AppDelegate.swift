...
//        let deleteAllRequest = NSBatchDeleteRequest(fetchRequest: DataModel.fetchRequest())
//        try! CoreDataStack.shared.persistentContainer.persistentStoreCoordinator.execute(deleteAllRequest,
